...
(function($) {
   ...
   $.widget("ui.weekCalendar", {
      ...
      _renderCalendar : function() {
         ...
         if (options.buttons) {
            calendarNavHtml = "<div   class=\"wc-nav\">\
                    <button style=\"font-weight: bold;font-size: 1em;\" class=\"wc-prev btn btn-danger\">" + options.buttonText.lastWeek + "</button>\
                    <button style=\"font-weight: bold;font-size: 1em;\" class=\"wc-today btn btn-success\">" + options.buttonText.today + "</button>\
                    <button style=\"font-weight: bold;font-size: 1em;\" class=\"wc-next btn btn-primary\">" + options.buttonText.nextWeek + "</button>\
                    </div>";
      ...
      _refreshEventDetails : function(calEvent, $calEvent) {
         ...
         //Alter the event display to show the title and then the body - date/time info is redundant
   ...
   $.extend($.ui.weekCalendar, {
      ...
      defaults: {
         ...
         newEventText : "Nouveau rendez vous ",
         timeslotHeight: 21,
         defaultEventLength : 1, // pour choiser la duré de consultation 
         timeslotsPerHour : 1,
         buttons : true,
         buttonText : {
            today : "Aujourd'hui",
...
*/
     shortMonths : ['Jan', 'Feb', 'Mar', 'Apr', 'Mai', 'Jun', 'Jui', 'Aoû', 'Sep', 'Oct', 'Nov', 'Dec'],
         longMonths : ['Janvier', 'Février', 'Mars', 'Avril', 'Mai', 'Juin', 'Juillet', 'Août', 'Septembre', 'Octobre', 'Novembre', 'Décembre'],
         shortDays : ['Dim', 'Mar', 'Mer', 'Jeu', 'Ven', 'Sam','Lu' ],
